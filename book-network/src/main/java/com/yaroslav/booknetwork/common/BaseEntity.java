...
public class BaseEntity { // Базовый класс для других сущностей
    ...
    String createdBy; // Идентификатор пользователя, который создал сущность
    ...
    String lastModifiedBy; // Идентификатор пользователя, который последний раз изменил сущность
}
