...
public class BookService {
    ...
    public PageResponse<BorrowedBookResponse> findAllBorrowedBooks(int page, int size, Authentication connectedUser) {
        ...
        Pageable pageable = PageRequest.of(
                ...
                size, // размер страницы
                Sort.by("createdDate").descending()); // сортировка по убыванию даты создания
        Page<BookTransactionHistory> allBorrowedBooks = bookTransactionHistoryRepository.finAllBorrowedBooks(pageable, user.getId());
    ...
    public PageResponse<BorrowedBookResponse> findAllReturnedBooks(int page, int size, Authentication connectedUser) {
        ...
        Pageable pageable = PageRequest.of(
                ...
                size, // размер страницы
                Sort.by("createdDate").descending()); // сортировка по убыванию даты создания
        Page<BookTransactionHistory> allBorrowedBooks = bookTransactionHistoryRepository.finAllReturnedBooks(pageable, user.getId());
        List<BorrowedBookResponse> bookResponses = allBorrowedBooks.stream()
                .map(bookMapper::toBorrowedBookResponse)
                .toList();
        return new PageResponse<>(
    ...
    public void uploadBookCoverPicture(MultipartFile file, Authentication connectedUser, Integer bookId) {
        ...
        var bookCover = fileStorageService.saveFile(file, user.getId()); // Сохраняет файл и возвращает путь к сохраненному файлу
